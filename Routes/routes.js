...
router.put('/editprojects/:pid',jwtmiddle,multer.single('image'),projectcontroller.editProject)

router.delete('/deleteprojects/:pid',jwtmiddle,projectcontroller.deleteprojects)
